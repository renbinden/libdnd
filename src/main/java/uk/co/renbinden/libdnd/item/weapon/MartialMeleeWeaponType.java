...
public class MartialMeleeWeaponType implements MartialWeaponType, MeleeWeaponType {
    ...
    public MartialMeleeWeaponType(String identifier, String name, Money cost, WeaponDamage damage, Weight weight, WeaponProperty... properties) {
