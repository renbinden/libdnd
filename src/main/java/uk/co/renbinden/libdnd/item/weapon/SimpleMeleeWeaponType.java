...
public class SimpleMeleeWeaponType implements SimpleWeaponType, MeleeWeaponType {
    ...
    public SimpleMeleeWeaponType(String identifier, String name, Money cost, WeaponDamage damage, Weight weight, WeaponProperty... properties) {
