...
public class SimpleRangedWeaponType implements SimpleWeaponType, RangedWeaponType {
    ...
    public SimpleRangedWeaponType(String identifier, String name, Money cost, WeaponDamage damage, Weight weight, WeaponProperty... properties) {
